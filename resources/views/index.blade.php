            ...
            <div class="container" style="width: 300px;">
                ...
                <div class="card card-cascade narrower">
                    ...
                    <div class="card-body card-body-cascade">
                        ...
                        <!-- Button -->
                        <a class="btn btn-unique offset-4" style="background-color: #A9CCCC; color: white">More</a>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn" style="background-color: #A9CCCC; color: white" data-toggle="modal" data-target="#modalAbandonedCart">Button</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Card title</h4>
                                    <p class="card-text">Price 300</p>
                                    <a class="btn" style="background-color: #A9CCCC; color: white" href="productsDetails.html">Button</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Card title</h4>
                                    <p class="card-text">Price 300</p>
                                    <a class="btn" style="background-color: #A9CCCC; color: white">Button</a>
                                </div>
                            </div>
                        </div>
                    </div>
